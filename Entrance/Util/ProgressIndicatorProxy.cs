...
// Originally from: http://www.codeproject.com/Articles/246355/Binding-the-WP7-ProgressIndicator-in-XAML?display=Print
...
namespace Entrance.Util
{
    public class ProgressIndicatorProxy : FrameworkElement
    {
        ...
        public void Attach()
        {
            ...
            var page = VisualTreeExtensions.GetVisualAncestor<PhoneApplicationPage>(this);
